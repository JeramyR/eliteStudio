      ...
      <div className="about-content">
        <div className="about-text">
          ...
          <p>
            ...
            enhance your natural beauty with expert cosmetic injections as well
            as other medical aesthetic procedures. Whether you’re looking to
            smooth fine lines, add volume, or rejuvenate your skin, I offer
